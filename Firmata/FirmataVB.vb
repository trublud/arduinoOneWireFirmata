...
Public Class FirmataVB
    ...
    Public Const STRING_DATA As Byte = 114  '0x71 a string message with 14-bits per character
    Public Const STRING_DATA2 As String = ""
    Public Const FIRMATA_STRING As Byte = 113 'testing
        ...
        Do While SerialPort1.BytesToRead > 0
            ...
            ElseIf (waitForData > 0 And inputData < 128) Then
                ...
                If ((waitForData = 0) And executeMultiByteCommand <> 0) Then
                    If inputData = (113 Or 114) Then MsgBox("f")
                    Select Case executeMultiByteCommand
                        ...
                        Case STRING_DATA
                            ...
                            '      MsgBox("got string command")
                            ' SetString(command)
                            SetString(storedInputData(1) >> 7)
                        Case FIRMATA_STRING
                            MsgBox("1: ")
                            ' SetString(FIRMATA_STRING)
    ...
    <Description("Stores received version number data")>
    ...
    End Sub
    Public Sub SetString(sstring As String)

        RaiseEvent DataStringReceieved(sstring)


    End Sub

    Public Event DataStringReceieved(dataString As String)
