...
#define FRIMATA_STRING 0b1110001
...
void printTemperature(DeviceAddress deviceAddress)
{
  ...
  {
    //  Firmata.sendString("Error: Could not read temperature data");
  //  Serial.println("Error: Could not read temperature data");
    return;
  }
  else{
    int watertemp = DallasTemperature::toFahrenheit(tempC);
  if (watertemp > 60) {
     Firmata.sendAnalog(0, tempC); 
//Serial.print(tempC);
  }
  }
 ...
 // Serial.println(DallasTemperature::toFahrenheit(tempC)); // Converts tempC to Fahrenheit
  ...
  //String stringOne =  String(DallasTemperature::toFahrenheit(tempC), 3);
  //char watertemp[stringOne.length()];
 // stringOne.toCharArray(watertemp, stringOne.length());
  // Firmata.sendString(" Temp F: ");
  // Firmata.sendString(watertemp);
  
 
 // stringOne =  String(tempC, 3);
//  stringOne.toCharArray(watertemp, stringOne.length());
  //  Firmata.sendString(" Temp C: ");
  //   Firmata.sendString(watertemp);
}
int tempcounter = 0;
/*==============================================================================
...
void loop()
{
 ...
 // Firmata.sendSysex(FIRMATA_STRING, 122, "HI");
